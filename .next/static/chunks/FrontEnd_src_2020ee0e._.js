...
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/FrontEnd/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
const API_BASE_URL = ("TURBOPACK compile-time value", "http://localhost:8000") || __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:8000';
/**
...
async function fetchWithRetry(url) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, maxRetries = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 3;
    const delays = [
        300,
        700
...
function transformBackendResponse(backendData) {
    ...
    var _current_pm2_5, _current_pm10, _current_ozone, _current_nitrogen_dioxide, _current_carbon_monoxide, _current_sulphur_dioxide;
    return {
        ...
        pollutants: [
            {
                name: 'PM2.5',
                value: (_current_pm2_5 = current.pm2_5) !== null && _current_pm2_5 !== void 0 ? _current_pm2_5 : null,
                unit: 'µg/m³'
            },
            {
                name: 'PM10',
                value: (_current_pm10 = current.pm10) !== null && _current_pm10 !== void 0 ? _current_pm10 : null,
                unit: 'µg/m³'
            },
            {
                name: 'O₃',
                value: (_current_ozone = current.ozone) !== null && _current_ozone !== void 0 ? _current_ozone : null,
                unit: 'µg/m³'
            },
            {
                name: 'NO₂',
                value: (_current_nitrogen_dioxide = current.nitrogen_dioxide) !== null && _current_nitrogen_dioxide !== void 0 ? _current_nitrogen_dioxide : null,
                unit: 'µg/m³'
            },
            {
                name: 'CO',
                value: (_current_carbon_monoxide = current.carbon_monoxide) !== null && _current_carbon_monoxide !== void 0 ? _current_carbon_monoxide : null,
                unit: 'µg/m³'
            },
            {
                name: 'SO₂',
                value: (_current_sulphur_dioxide = current.sulphur_dioxide) !== null && _current_sulphur_dioxide !== void 0 ? _current_sulphur_dioxide : null,
                unit: 'µg/m³'
            }
...
async function fetchAQIData() {
    let city = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 'New York';
    try {
        const controller = new AbortController();
        const timeoutId = setTimeout(()=>controller.abort(), 20000); // 20 second timeout
        try {
            const response = await fetch("".concat(API_BASE_URL, "/api/aqi?city=").concat(encodeURIComponent(city)), {
                signal: controller.signal
            });
            clearTimeout(timeoutId);
            if (!response.ok) {
                console.warn("Failed to fetch AQI data for ".concat(city, ": ").concat(response.statusText));
                return null;
            }
            ...
            if (fetchError.name === 'AbortError') {
                console.warn("Request timeout for ".concat(city, " - server took too long to respond"));
                return null;
            }
            console.warn("Error fetching AQI data for ".concat(city, ":"), fetchError);
            return null;
        }
    } catch (error) {
...
async function fetchAQITrend() {
    let city = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 'New York';
    try {
        const response = await fetchWithRetry("".concat(API_BASE_URL, "/api/aqi/trend?city=").concat(encodeURIComponent(city)), {}, 3 // 3 retries
        );
        if (!response || !response.ok) {
            console.warn("Failed to fetch AQI trend data for ".concat(city, ": ").concat((response === null || response === void 0 ? void 0 : response.statusText) || 'Unknown error', " (status: ").concat((response === null || response === void 0 ? void 0 : response.status) || 'N/A', ")"));
            return [];
        }
        const data = await response.json();
        return Array.isArray(data) ? data : [];
    } catch (error) {
        console.error("Error fetching AQI trend for ".concat(city, ":"), error);
        return [];
    }
}
async function fetchCityRankings() {
    try {
        const response = await fetchWithRetry("".concat(API_BASE_URL, "/api/cities/rankings/"), {}, 3 // 3 retries
        );
        if (!response || !response.ok) {
...
async function fetchAQIByCoordinates(lat, lng, signal) {
    try {
        const response = await fetchWithRetry("".concat(API_BASE_URL, "/api/aqi/coordinates?lat=").concat(lat, "&lng=").concat(lng), {
            signal
        });
        if (!response || !response.ok) {
            console.warn("Failed to fetch AQI data by coordinates: ".concat((response === null || response === void 0 ? void 0 : response.statusText) || 'Unknown error'));
            return null;
        }
        const data = await response.json();
...
async function fetchAQIBatch(locations, signal) {
    try {
        const response = await fetchWithRetry("".concat(API_BASE_URL, "/api/aqi/batch"), {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
        ...
        if (!response || !response.ok) {
            console.warn("Failed to fetch batch AQI data: ".concat((response === null || response === void 0 ? void 0 : response.statusText) || 'Unknown error'));
            return [];
        }
        const data = await response.json();
...
async function fetchEnhancedAQIByCoordinates(lat, lng, signal) {
    try {
        const response = await fetchWithRetry("".concat(API_BASE_URL, "/api/aqi/enhanced?lat=").concat(lat, "&lng=").concat(lng), {
            signal
        });
        if (!response || !response.ok) {
            console.warn("Failed to fetch enhanced AQI data: ".concat((response === null || response === void 0 ? void 0 : response.statusText) || 'Unknown error'));
            return null;
        }
        return await response.json();
    } catch (error) {
...
async function fetchEnhancedAQIBatch(locations, signal) {
    try {
        const response = await fetchWithRetry("".concat(API_BASE_URL, "/api/aqi/batch/enhanced"), {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
        ...
        if (!response || !response.ok) {
            console.warn("Failed to fetch enhanced batch AQI data: ".concat((response === null || response === void 0 ? void 0 : response.statusText) || 'Unknown error'));
            return [];
        }
        return await response.json();
    } catch (error) {
...
async function geocodeCity(city) {
    try {
        const response = await fetchWithRetry("".concat(API_BASE_URL, "/api/aqi/geocode/?city=").concat(encodeURIComponent(city)));
        if (!response || !response.ok) {
            return null;
        }
        return await response.json();
...
async function register(userData) {
    ...
    if (!response.ok) {
        ...
        if (response.status === 422 && Array.isArray(error.detail)) {
            const validationErrors = error.detail.map((err)=>"".concat(err.field, ": ").concat(err.message)).join(', ');
...
async function logout(refreshToken) {
    try {
        await fetch("".concat(API_BASE_URL, "/api/auth/logout"), {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function refreshToken(refreshTokenValue) {
    const response = await fetch("".concat(API_BASE_URL, "/api/auth/refresh"), {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function getCurrentUser() {
    const response = await fetch("".concat(API_BASE_URL, "/api/auth/me"), {
        headers: getAuthHeaders()
    });
    if (!response.ok) {
        if (response.status === 401) {
...
async function verifyEmail(token) {
    const response = await fetch("".concat(API_BASE_URL, "/api/auth/verify-email/?token=").concat(token), {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        }
    ...
    if (!response.ok) {
        ...
        if (contentType && contentType.includes('application/json')) {
            ...
            throw new Error("Email verification failed: ".concat(response.status, " ").concat(response.statusText));
        }
    }
...
async function resendVerification(email) {
    const response = await fetch("".concat(API_BASE_URL, "/api/auth/resend-verification"), {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function forgotPassword(email) {
    const response = await fetch("".concat(API_BASE_URL, "/api/auth/forgot-password"), {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function resetPassword(token, newPassword) {
    const response = await fetch("".concat(API_BASE_URL, "/api/auth/reset-password"), {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function getSubscriptions() {
    const response = await fetch("".concat(API_BASE_URL, "/api/aqi/subscriptions/"), {
        headers: {
            ...getAuthHeaders(),
            'Content-Type': 'application/json'
        }
...
async function createSubscription(data) {
    ...
    if (!response.ok) {
        ...
        if (response.status === 400) {
            const fieldErrors = Object.entries(error).filter((param)=>{
                let [key] = param;
                return key !== 'detail';
            }).map((param)=>{
                let [key, value] = param;
                const errorMsg = Array.isArray(value) ? value[0] : value;
                return "".concat(key, ": ").concat(errorMsg);
            });
...
async function deleteSubscription(id) {
    const response = await fetch("".concat(API_BASE_URL, "/api/aqi/subscriptions/").concat(id, "/"), {
        method: 'DELETE',
        headers: {
            ...getAuthHeaders(),
            'Content-Type': 'application/json'
...
async function toggleSubscription(id) {
    const response = await fetch("".concat(API_BASE_URL, "/api/aqi/subscriptions/").concat(id, "/toggle/"), {
        method: 'PATCH',
        headers: {
            ...getAuthHeaders(),
            'Content-Type': 'application/json'
...
async function sendSubscriptionNotification(id, aqi_value) {
    ...
    const response = await fetch("".concat(API_BASE_URL, "/api/aqi/subscriptions/").concat(id, "/send_notification/"), {
        method: 'POST',
        headers: {
            ...getAuthHeaders(),
            'Content-Type': 'application/json'
...
"[project]/FrontEnd/src/hooks/use-main-aqi-data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useMainAqiData(options) {
    _s();
    const city = (options === null || options === void 0 ? void 0 : options.city) || DEFAULT_CITY;
    const coordinates = options === null || options === void 0 ? void 0 : options.coordinates;
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])(); // Get authentication status
    const [aqiData, setAqiData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainAqiData"]);
    const [trendData, setTrendData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["aqiTrendData"]);
    ...
    const [retryCount, setRetryCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMainAqiData.useEffect": ()=>{
            let isMounted = true;
            let refreshTimer = null;
            const fetchData = {
                "useMainAqiData.useEffect.fetchData": async ()=>{
                    ...
                    try {
                        ...
                        setError(null);
                        setRetryCount({
                            "useMainAqiData.useEffect.fetchData": (prev)=>prev + 1
                        }["useMainAqiData.useEffect.fetchData"]);
                        ...
                        const [aqiResponse, trendResponse] = await Promise.allSettled([
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAQIByCoordinates"])(coordinates.lat, coordinates.lng),
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchAQITrend"])(city)
                        ]);
                        if (!isMounted) return;
                        // Handle AQI data
                        if (aqiResponse.status === 'fulfilled' && aqiResponse.value) {
                            ...
                            if (hasValidData) {
                                ...
                                if (isInitialLoad) {
                                    ...
                                    setAqiData({
                                        ...__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mainAqiData"],
            ...
            }["useMainAqiData.useEffect"], REFRESH_INTERVAL);
            // Cleanup
            return ({
                "useMainAqiData.useEffect": ()=>{
                    isMounted = false;
...
_s(useMainAqiData, "VEbJyaehW8CabK9IA5sFub//FI8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
"[project]/FrontEnd/src/components/dashboard/hero-aqi-card.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/ui/button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/lib/data.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$hooks$2f$use$2d$main$2d$aqi$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/hooks/use-main-aqi-data.ts [app-client] (ecmascript)");
...
const pollutantIcons = {
    'PM2.5': __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$leaf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Leaf$3e$__["Leaf"],
    'PM10': __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$mountain$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Mountain$3e$__["Mountain"],
    'NO₂': __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$cloud$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Cloud$3e$__["Cloud"],
    'O₃': __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$wind$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Wind$3e$__["Wind"],
    'CO': __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertCircle$3e$__["AlertCircle"],
    'SO₂': __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$alert$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__AlertCircle$3e$__["AlertCircle"]
};
function HeroAqiCard(param) {
    let { city, coordinates, onResetToUserCity, isViewingUserCity = true } = param;
    _s();
    const { aqiData, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$hooks$2f$use$2d$main$2d$aqi$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMainAqiData"])({
        city,
        coordinates
    });
    ...
    const aqiColorClass = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAqiColor"])(aqi);
    const usEpaAqiValue = usEpaAqi !== null && usEpaAqi !== void 0 ? usEpaAqi : aqi;
    const usEpaAqiStyle = aqiColor ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAqiStyleFromHex"])(aqiColor) : {};
    if (loading && !aqiCity) {
            ...
            children: [
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAqiRingColor"])(usEpaAqiValue),
                                            strokeDasharray: "".concat(usEpaAqiValue / 500 * 100, ", 100"),
                                            d: "M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831",
                                            fill: "none",
                                            strokeWidth: "2.5",
                                            strokeLinecap: "round"
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-6xl font-bold ".concat(aqiColorClass),
                                            style: usEpaAqiStyle,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                    className: "text-2xl font-semibold ".concat(aqiColorClass),
                                    style: usEpaAqiStyle,
                                ...
                                dominantPollutant && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        error && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "grid gap-4 p-4 rounded-lg bg-muted/30 ".concat(globalAqi != null || localAqi != null ? 'grid-cols-3' : 'grid-cols-1'),
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        pm25Concentration != null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-muted-foreground mt-1",
                                            children: [
                                                "PM2.5: ",
                                ...
                                globalAqi != null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-center",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-muted-foreground mb-1",
                                ...
                                localAqi != null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "text-center",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-muted-foreground mb-1",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                pollutants.map((p)=>{
                                    const Icon = pollutantIcons[p.name] || __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$leaf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Leaf$3e$__["Leaf"];
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(HeroAqiCard, "FsIA8KzOEWVI0Ly207U0aE3UFIM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$hooks$2f$use$2d$main$2d$aqi$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMainAqiData"]
    ];
});
_c = HeroAqiCard;
var _c;
__turbopack_context__.k.register(_c, "HeroAqiCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const ChartContext = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"](null);
function useChart() {
    _s();
    const context = __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"](ChartContext);
    if (!context) {
...
const ChartContainer = /*#__PURE__*/ _s1(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](_c = _s1((param, ref)=>{
    let { id, className, children, config, ...props } = param;
    _s1();
    const uniqueId = __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useId"]();
    const chartId = "chart-".concat(id || uniqueId.replace(/:/g, ""));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChartContext.Provider, {
        value: {
            config
        },
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            ...props,
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ChartStyle, {
                    id: chartId,
                    config: config
                }, void 0, false, {
...
const ChartStyle = (param)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("style", {
...
_c2 = ChartStyle;
const ChartTooltip = __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$recharts$2f$es6$2f$component$2f$Tooltip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tooltip"];
const ChartTooltipContent = /*#__PURE__*/ _s2(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](_c3 = _s2((param, ref)=>{
    ...
    const tooltipLabel = __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: payload.map((item, index)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: formatter && (item === null || item === void 0 ? void 0 : item.value) !== undefined && item.name ? formatter(item.value, item.name, item, index, item.payload) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                (itemConfig === null || itemConfig === void 0 ? void 0 : itemConfig.icon) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(itemConfig.icon, {}, void 0, false, {
                                    fileName: "[project]/FrontEnd/src/components/ui/chart.tsx",
                                    lineNumber: 206,
                                    columnNumber: 23
                                }, ("TURBOPACK compile-time value", void 0)) : !hideIndicator && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        item.value && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
const ChartLegend = __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$recharts$2f$es6$2f$component$2f$Legend$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Legend"];
const ChartLegendContent = /*#__PURE__*/ _s3(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](_c5 = _s3((param, ref)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: payload.map((item)=>{
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    (itemConfig === null || itemConfig === void 0 ? void 0 : itemConfig.icon) && !hideIcon ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(itemConfig.icon, {}, void 0, false, {
                        fileName: "[project]/FrontEnd/src/components/ui/chart.tsx",
                        lineNumber: 300,
                        columnNumber: 17
...
"[project]/FrontEnd/src/components/dashboard/aqi-trend-chart.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AqiTrendChart(param) {
    let { data } = param;
    var _hourly_time;
    const hourly = (data === null || data === void 0 ? void 0 : data.hourly) || {};
    // Transform Hourly Data (Next 24h)
    const chartData = ((_hourly_time = hourly.time) === null || _hourly_time === void 0 ? void 0 : _hourly_time.slice(0, 24).map((time, i)=>{
        var _hourly_pm2_5;
        return {
            ...
            aqi: ((_hourly_pm2_5 = hourly.pm2_5) === null || _hourly_pm2_5 === void 0 ? void 0 : _hourly_pm2_5[i]) || 0
        };
    })) || [];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
...
_c = AqiTrendChart;
var _c;
__turbopack_context__.k.register(_c, "AqiTrendChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/FrontEnd/src/components/dashboard/future-prediction-chart.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FuturePredictionChart(param) {
    let { data } = param;
    var _hourly_time;
    const hourly = (data === null || data === void 0 ? void 0 : data.hourly) || {};
    // Transform Hourly Data (Next 24h)
    const chartData = ((_hourly_time = hourly.time) === null || _hourly_time === void 0 ? void 0 : _hourly_time.slice(0, 24).map((time, i)=>{
        ...
        return {
            ...
            pm25: ((_hourly_pm2_5 = hourly.pm2_5) === null || _hourly_pm2_5 === void 0 ? void 0 : _hourly_pm2_5[i]) || 0
        };
    })) || [];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "glass h-full transition-all duration-300 hover:shadow-2xl",
...
_c = FuturePredictionChart;
var _c;
__turbopack_context__.k.register(_c, "FuturePredictionChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/FrontEnd/src/components/dashboard/pollutant-distribution-chart.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PollutantDistributionChart(param) {
    let { data } = param;
    // Convert pollutants from AQI data to distribution format
    const getDistributionData = ()=>{
        if (!(data === null || data === void 0 ? void 0 : data.pollutants) || Object.keys(data.pollutants).length === 0) {
            return [];
        }
...
_c = PollutantDistributionChart;
var _c;
__turbopack_context__.k.register(_c, "PollutantDistributionChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/FrontEnd/src/components/dashboard/historical-comparison-chart.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function HistoricalComparisonChart(param) {
    let { data } = param;
    var _daily_time;
    const daily = (data === null || data === void 0 ? void 0 : data.daily) || {};
    // Transform Daily Data
    const chartData = ((_daily_time = daily.time) === null || _daily_time === void 0 ? void 0 : _daily_time.map((time, i)=>{
        var _daily_pm2_5, _daily_nitrogen_dioxide, _daily_ozone;
        return {
            date: time,
            pm25: ((_daily_pm2_5 = daily.pm2_5) === null || _daily_pm2_5 === void 0 ? void 0 : _daily_pm2_5[i]) || 0,
            no2: ((_daily_nitrogen_dioxide = daily.nitrogen_dioxide) === null || _daily_nitrogen_dioxide === void 0 ? void 0 : _daily_nitrogen_dioxide[i]) || 0,
            o3: ((_daily_ozone = daily.ozone) === null || _daily_ozone === void 0 ? void 0 : _daily_ozone[i]) || 0
        };
    })) || [];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "glass h-full transition-all duration-300 hover:shadow-2xl",
...
var _c;
__turbopack_context__.k.register(_c, "HistoricalComparisonChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/FrontEnd/src/lib/city-ranking-data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/FrontEnd/src/hooks/use-city-rankings.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/contexts/auth-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/lib/api-client.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$city$2d$ranking$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/lib/city-ranking-data.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
'use client';
;
;
...
function useCityRankings() {
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const [rankings, setRankings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$city$2d$ranking$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cityRankingsData"]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [lastUpdated, setLastUpdated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [connectionAttempts, setConnectionAttempts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const pollIntervalRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // Fetch rankings via REST API
    const fetchRankings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useCityRankings.useCallback[fetchRankings]": async ()=>{
            // Don't fetch if user is not authenticated
            if (!user) {
                setLoading(false);
                return;
            ...
            try {
                ...
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCityRankings"])();
                if (data && data.length > 0) {
                    ...
                    console.log("✓ Fetched ".concat(data.length, " city rankings"));
                }
            } catch (err) {
                ...
                setConnectionAttempts({
                    "useCityRankings.useCallback[fetchRankings]": (prev)=>prev + 1
                }["useCityRankings.useCallback[fetchRankings]"]);
            } finally{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCityRankings.useEffect": ()=>{
            ...
            console.log("→ Starting rankings poll (every ".concat(POLL_INTERVAL / 1000, "s)"));
            pollIntervalRef.current = setInterval({
                "useCityRankings.useEffect": ()=>{
                    fetchRankings();
                }
            }["useCityRankings.useEffect"], POLL_INTERVAL);
            return ({
                "useCityRankings.useEffect": ()=>{
                    // Cleanup on unmount
    ...
    const refetch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useCityRankings.useCallback[refetch]": ()=>{
            fetchRankings();
        }
    }["useCityRankings.useCallback[refetch]"], [
        fetchRankings
...
_s(useCityRankings, "qmhTHYa3G2gjee9MyGVVyJ84WAY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
"[project]/FrontEnd/src/components/dashboard/live-city-ranking-widget.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/ui/card.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/lib/data.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$hooks$2f$use$2d$city$2d$rankings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/hooks/use-city-rankings.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/ui/button.tsx [app-client] (ecmascript)");
...
function LiveCityRankingWidget() {
    _s();
    const { rankings, loading, isRefreshing, isConnected } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$hooks$2f$use$2d$city$2d$rankings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCityRankings"])();
    const topCities = rankings.length > 0 ? rankings.slice(0, 5) : __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$city$2d$ranking$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cityRankingsData"].slice(0, 5);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "glass h-full transition-all duration-300 hover:shadow-2xl",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                        ...
                        children: [
                            ...
                            !loading && isConnected && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            !loading && !isConnected && !isRefreshing && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                    ...
                    children: topCities.map((city, index)=>{
                        var _city_aqi_pm25, _ref;
                        // Use PM2.5 AQI as primary, fallback to PM10 AQI, then to aqi field
                        const primaryAqi = (_ref = (_city_aqi_pm25 = city.aqi_pm25) !== null && _city_aqi_pm25 !== void 0 ? _city_aqi_pm25 : city.aqi_pm10) !== null && _ref !== void 0 ? _ref : city.aqi;
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "flex h-2.5 w-2.5 shrink-0 rounded-full transition-all ".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAqiColor"])(primaryAqi).replace('text-', 'bg-'), " group-hover:scale-125")
                                        }, void 0, false, {
                                            fileName: "[project]/FrontEnd/src/components/dashboard/live-city-ranking-widget.tsx",
                                            lineNumber: 50,
                                            columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "font-bold text-lg transition-all group-hover:scale-110 ".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAqiColor"])(primaryAqi)),
                                            children: primaryAqi
                                        }, void 0, false, {
                                            fileName: "[project]/FrontEnd/src/components/dashboard/live-city-ranking-widget.tsx",
                                            lineNumber: 61,
                                        ...
                                        city.aqi_pm10 !== undefined && city.aqi_pm10 !== null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-muted-foreground ".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAqiColor"])(city.aqi_pm10)),
                                            children: [
                                                "PM10: ",
                                                city.aqi_pm10
                                            ]
                        ...
                        }, "".concat(city.city, "-").concat(city.country), true, {
                            fileName: "[project]/FrontEnd/src/components/dashboard/live-city-ranking-widget.tsx",
                            lineNumber: 44,
                            columnNumber: 15
                        }, this);
...
_s(LiveCityRankingWidget, "doieQgulYXjTqrC7IzVTc1me49A=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$hooks$2f$use$2d$city$2d$rankings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCityRankings"]
    ];
});
_c = LiveCityRankingWidget;
var _c;
__turbopack_context__.k.register(_c, "LiveCityRankingWidget");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/FrontEnd/src/components/auth/protected-route.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProtectedRoute(param) {
    let { children, requireVerified = false } = param;
    _s();
    const { user, loading, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$hero$2d$aqi$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/dashboard/hero-aqi-card.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$aqi$2d$trend$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/dashboard/aqi-trend-chart.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$future$2d$prediction$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/dashboard/future-prediction-chart.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$pollutant$2d$distribution$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/dashboard/pollutant-distribution-chart.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$historical$2d$comparison$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/dashboard/historical-comparison-chart.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$live$2d$city$2d$ranking$2d$widget$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/dashboard/live-city-ranking-widget.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$auth$2f$protected$2d$route$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/components/auth/protected-route.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/contexts/auth-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/FrontEnd/src/lib/api-client.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function Home() {
    ...
    const [selectedCoordinates, setSelectedCoordinates] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [enhancedData, setEnhancedData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [locationError, setLocationError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
            ...
            if (selectedCoordinates) {
                const fetchData = {
                    "Home.useEffect.fetchData": async ()=>{
                        try {
                            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchEnhancedAQIByCoordinates"])(selectedCoordinates.lat, selectedCoordinates.lng);
    ...
    const handleResetToUserCity = async ()=>{
        ...
        if (user === null || user === void 0 ? void 0 : user.city) {
            setSelectedCity(user.city);
            ...
            if (user.latitude && user.longitude) {
                ...
                try {
                    const geocoded = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["geocodeCity"])(user.city);
                    if (geocoded) {
                        setSelectedCoordinates({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$auth$2f$protected$2d$route$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$hero$2d$aqi$2d$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                city: selectedCity || undefined,
                                coordinates: selectedCoordinates || undefined,
                                onResetToUserCity: handleResetToUserCity,
                                isViewingUserCity: selectedCity === (user === null || user === void 0 ? void 0 : user.city)
                            }, void 0, false, {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$future$2d$prediction$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                data: enhancedData
                            }, void 0, false, {
                                fileName: "[project]/FrontEnd/src/app/page.tsx",
                                lineNumber: 166,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$live$2d$city$2d$ranking$2d$widget$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                                fileName: "[project]/FrontEnd/src/app/page.tsx",
                                lineNumber: 172,
                                columnNumber: 15
                            }, this)
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$aqi$2d$trend$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                data: enhancedData
                            }, void 0, false, {
                                fileName: "[project]/FrontEnd/src/app/page.tsx",
                                lineNumber: 178,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$pollutant$2d$distribution$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                data: enhancedData
                            }, void 0, false, {
                                fileName: "[project]/FrontEnd/src/app/page.tsx",
                                lineNumber: 184,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$components$2f$dashboard$2f$historical$2d$comparison$2d$chart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                data: enhancedData
                            }, void 0, false, {
                                fileName: "[project]/FrontEnd/src/app/page.tsx",
                                lineNumber: 190,
...
_s(Home, "G7lNMQAxAXZ8L6w8Iv8c/gyrmyc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$FrontEnd$2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=FrontEnd_src_2020ee0e._.js.map